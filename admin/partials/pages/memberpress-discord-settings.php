...
<input type="hidden" name="current_url" value="<?php echo esc_html( $current_url ); ?> " />
	...
	<div class="ets-input-group">
		...
		<input type="text" class="ets-input" name="ets_memberpress_discord_client_secret" value="<?php if ( isset( $discord_client_secret ) ) { echo esc_attr( $discord_client_secret ); } ?>" required placeholder="<?php echo __( 'Discord Client Secret', 'connect-memberpress-discord-add-on' ); ?>">
	</div>
	<div class="ets-input-group">
