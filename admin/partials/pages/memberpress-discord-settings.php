...
<input type="hidden" name="action" value="memberpress_discord_general_settings">
	...
	<div class="ets-input-group">
		...
		<input type="text" class="ets-input" name="ets_memberpress_discord_client_secret" value="<?php if ( isset( $discord_client_secret ) ) { echo esc_attr( $discord_client_secret ); } ?>" required placeholder="<?php echo __( 'Discord Client Secret', 'ets_memberpress_discord' ); ?>">
	</div>
	<div class="ets-input-group">
		<label><?php echo __( 'Redirect URL', 'ets_memberpress_discord' ); ?> :</label>
		<input type="text" class="ets-input" name="ets_memberpress_discord_redirect_url" placeholder="<?php echo __( 'Discord Redirect Url', 'ets_memberpress_discord' ); ?>" value="<?php if ( isset( $ets_memberpress_discord_redirect_url ) ) { echo esc_attr( $ets_memberpress_discord_redirect_url ); } ?>" required>
	...
	<div class="ets-input-group">
		...
		<input type="text" class="ets-input" name="ets_memberpress_discord_bot_token" value="<?php if ( isset( $discord_bot_token ) ) { echo esc_attr( $discord_bot_token ); } ?>" required placeholder="<?php echo __( 'Discord Bot Token', 'ets_memberpress_discord' ); ?>">
	</div>
	<div class="ets-input-group">
		<label><?php echo __( 'Server Id', 'ets_memberpress_discord' ); ?> :</label>
		<input type="text" class="ets-input" name="ets_memberpress_discord_server_id" placeholder="<?php echo __( 'Discord Server Id', 'ets_memberpress_discord' ); ?>" value="<?php if ( isset( $ets_memberpress_discord_server_id ) ) { echo esc_attr( $ets_memberpress_discord_server_id ); } ?>" required>
	</div>
