...
<?php wp_nonce_field( 'save_discord_aprnc_settings', 'ets_discord_save_aprnc_settings' ); ?>
  ...
  <tr>
		...
		if ( $ets_memberpress_discord_btn_disconnect_color ) {
			echo $ets_memberpress_discord_btn_disconnect_color; }
		?>
  ...
  <tr>
	...
	<tr>
		<th scope="row"><?php echo __( 'Message for roles assigned or to be assigned', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
