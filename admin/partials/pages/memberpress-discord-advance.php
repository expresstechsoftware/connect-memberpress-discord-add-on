...
<?php wp_nonce_field( 'save_discord_adv_settings', 'ets_discord_save_adv_settings' ); ?>
  <table class="form-table" role="presentation">
	<tbody>
	<tr>
		<th scope="row"><?php echo __( 'Shortcode:', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
		[mepr_discord_button]
		<br/>
		<small><?php echo __( 'Use this shortcode to display Discord Connect button anywhere on your website, Optionally you can make your redirect url to that page on which the button shortcode is being added.', 'connect-memberpress-discord-add-on' ); ?></small>
		</fieldset></td>
	  </tr>
	<tr>
  <tr>
		<th scope="row"><?php echo __( 'Send welcome message', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Membership welcome message', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Send membership expiration warning message', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Membership expiration warning message', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Send membership expired message', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Membership expired message', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Send membership cancel message', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
		...
		<tr>
		<th scope="row"><?php echo __( 'Membership cancel message', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
  ...
  <tr>
		<th scope="row"><?php echo __( 'Re-assign roles upon payment failure', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
		...
		<th scope="row"><?php echo __( 'Retry Failed API calls', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
	  ...
	  <tr>
		<th scope="row"><?php echo __( 'Kick members out when they Disconnect their Account?', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
		...
		?>
		 value="1"><br/>
     <small><?php echo __( 'Members will be kicked out if this setting is checked.', 'connect-memberpress-discord-add-on' ); ?></small>
		</fieldset></td>
		
	  </tr>
	  <tr>
		<th scope="row"><?php echo __( 'Login with Discord on checkout Page', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
    ...
    <small><?php echo __( 'A new account will be created if the discord account E-mail is not exist into the system.', 'connect-memberpress-discord-add-on' ); ?></small>
  </td>
	  </tr>
	<tr>
		<th scope="row"><?php echo __( 'How many times a failed API call should get re-try', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
	  ...
	  <tr>
		<th scope="row"><?php echo __( 'Set job queue concurrency', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
	  ...
	  <tr>
		<th scope="row"><?php echo __( 'Set job queue batch size', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php echo __( 'Log API calls response (For debugging purpose)', 'connect-memberpress-discord-add-on' ); ?></th>
		<td> <fieldset>
