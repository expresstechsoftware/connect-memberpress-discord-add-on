	...
	<form method="post" action="<?php echo esc_attr( get_site_url() ) . '/wp-admin/admin-post.php' ?>">
	  ...
	  <div class="ets-container">
		<div class="top-logo-title">
		  ...
		  <h1><?php echo __( 'ExpressTech Softwares Solutions Pvt. Ltd.', 'memberpress-discord-add-on' ); ?></h1>
		  <p><?php echo __( 'ExpressTech Software Solution Pvt. Ltd. is the leading Enterprise WordPress development company.', 'memberpress-discord-add-on' ); ?><br>
		  <?php echo __( 'Contact us for any WordPress Related development projects.', 'memberpress-discord-add-on' ); ?></p>
		</div>
			...
			<div class="ets-col-7 ets-offset-md-1">
			  <div class="contact-fields pr-100">
				<div class="ets-form-group">
				  <label><?php echo __( 'Full Name', 'memberpress-discord-add-on' ); ?></label>
				  <input type="text" name="ets_user_name" value="<?php echo esc_html( $currUserName ); ?>" class="form-control contact-input" placeholder="<?php echo __( 'Write Your Full Name', 'memberpress-discord-add-on' ); ?>">
				  <?php wp_nonce_field( 'send_support_mail', 'ets_discord_send_support_mail' ); ?>
				</div>
				<div class="ets-form-group">
				  <label><?php echo __( 'Contact Email', 'memberpress-discord-add-on' ); ?></label>
				  <input type="text" name="ets_user_email" class="form-control contact-input" value="<?php echo esc_attr( get_option( 'admin_email' ) ); ?>" placeholder="<?php echo __( 'Write Your Email', 'memberpress-discord-add-on' ); ?>">
				</div>
				<div class="ets-form-group">
				  <label><?php echo __( 'Subject', 'memberpress-discord-add-on' ); ?></label>
				  <input type="text" name="ets_support_subject" class="form-control contact-input" placeholder="<?php echo __( 'Write Your Subject', 'memberpress-discord-add-on' ); ?>" required="">
				</div>
				<div class="ets-form-group">
				  <label><?php echo __( 'Message', 'memberpress-discord-add-on' ); ?></label>
				...
				<div class="submit-btn d-flex align-items-center w-100 pt-3">
				  ...
				  <a href="skype:ravi.soni971?chat" class="btn btn-skype ml-auto"><?php echo __( 'Skype', 'memberpress-discord-add-on' ); ?></a>
				</div>
			  </div>
			</div>
			<div class="ets-col-3">
			  <div class="right-side-box">
				<div class="contact-details d-inline-block w-100 mb-4">
				  <div class="top-icon-title d-flex align-items-center w-100">
					...
					<p><?php echo __( 'Email', 'memberpress-discord-add-on' ); ?></p>
				  </div>
				...
				<div class="contact-details d-inline-block w-100 mb-4">
				  <div class="top-icon-title d-flex align-items-center w-100">
					...
					<p><?php echo __( 'Skype', 'memberpress-discord-add-on' ); ?></p>
				  </div>
				  <div class="contact-body mt-3">
					<p><?php echo __( 'ravi.soni971', 'memberpress-discord-add-on' ); ?></p>
				  </div>
				</div>
				<div class="contact-details d-inline-block w-100">
				  <div class="top-icon-title d-flex align-items-center w-100">
					<i class="fab fa-whatsapp title-icon fa-lg fa-inverse" aria-hidden="true"></i>
					<p><?php echo __( 'Whatsapp / Phone', 'memberpress-discord-add-on' ); ?></p>
				  </div>
				  <div class="contact-body mt-3">
