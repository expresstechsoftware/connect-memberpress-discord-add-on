  ...
  <form accept="#" method="post">
	  <div class="ets-container">
		<div class="top-logo-title">
		  <img src="<?php echo plugin_dir_path( __FILE__ )  . 'assets/images/ets-logo.png'; ?>" class="img-fluid company-logo" alt="">
		  <h1><?php echo __( 'ExpressTech Softwares Solutions Pvt. Ltd.', 'ets_mepr_discord' ); ?></h1>
		  <p><?php echo __( 'ExpressTech Software Solution Pvt. Ltd. is the leading Enterprise WordPress development company.', 'ets_mepr_discord' ); ?><br>
		  <?php echo __( 'Contact us for any WordPress Related development projects.', 'ets_mepr_discord' ); ?></p>
		</div>
			...
			<div class="ets-col-7 ets-offset-md-1">
			  <div class="contact-fields pr-100">
				<div class="ets-form-group">
				  <label><?php echo __( 'Full Name', 'ets_mepr_discord' ); ?></label>
				...
				<div class="ets-form-group">
				  <label><?php echo __( 'Contact Email', 'ets_mepr_discord' ); ?></label>
				...
				<div class="submit-btn d-flex align-items-center w-100 pt-3">
				  ...
				  <a href="skype:ravi.soni971?chat" class="btn btn-skype ml-auto"><?php echo __( 'Skype', 'ets_mepr_discord' ); ?></a>
				</div>
			  </div>
			</div>
			<div class="ets-col-3">
			  <div class="right-side-box">
				<div class="contact-details d-inline-block w-100 mb-4">
				  <div class="top-icon-title d-flex align-items-center w-100">
					...
					<p><?php echo __( 'Email', 'ets_mepr_discord' ); ?></p>
				  </div>
				  <div class="contact-body mt-3">
					<p><a href="mailto:contact@expresstechsoftwares.com"><?php echo __( 'contact@expresstechsoftwares.com', 'ets_mepr_discord' ); ?></a></p>
					<p><a href="mailto:business@expresstechsoftwares.com"><?php echo __( 'business@expresstechsoftwares.com', 'ets_mepr_discord' ); ?></a></p>
				  </div>
				</div>
				<div class="contact-details d-inline-block w-100 mb-4">
				  <div class="top-icon-title d-flex align-items-center w-100">
					<i class="fab fa-skype title-icon fa-lg fa-inverse" aria-hidden="true"></i>
					<p><?php echo __( 'Skype', 'ets_mepr_discord' ); ?></p>
				  </div>
				  <div class="contact-body mt-3">
					<p><?php echo __( 'ravi.soni971', 'ets_mepr_discord' ); ?></p>
				  </div>
				</div>
				<div class="contact-details d-inline-block w-100">
				  <div class="top-icon-title d-flex align-items-center w-100">
					<i class="fab fa-whatsapp title-icon fa-lg fa-inverse" aria-hidden="true"></i>
					<p><?php echo __( 'Whatsapp / Phone', 'ets_mepr_discord' ); ?></p>
				  </div>
				  <div class="contact-body mt-3">
					<p><?php echo __( '+91-9806724185', 'ets_mepr_discord' ); ?></p>
				  </div>
				</div>
			  </div>
			</div>
